...
public class SearchMediaControl extends BroadcastReceiver {
    private static SearchMediaControl instance; // Singleton instance
    private ExoPlayer exoPlayer;
    private ArrayList<SearchPlaylistDTO> playList = new ArrayList<>();
    private int currentPos;
    public boolean isRegister;
    private Boolean isShuffle = false
            , isLoop = false;

    private SearchMediaControl(){ }
    public static SearchMediaControl getInstance(){
        if (instance == null){
            instance = new SearchMediaControl();
        }
        return instance;
    }
    ...
    public void addPlaylist(ArrayList<SearchPlaylistDTO> items){
        if (exoPlayer != null){
    ...
    public SearchPlaylistDTO getCurrentSong() {
